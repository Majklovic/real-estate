...
const Header = () => {
  return (
    <div className="min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden" style={{backgroundImage: "url('/header_img.png')"}} id='Header'>
      ...
      viewport={{once: true}}
      className='conteiner text-center mx-auto py-4 px-6 md:px-20 lg:px-32 text-white'>
        ...
        <div className='space-x-6 mt-16'>
          <a href="#Projects" className='border broder-white px-8 py-3 rounded'>Projects</a>
